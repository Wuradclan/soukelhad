...
export const translations = {
  ar: {
    ...
    user: {
      ...
      shareSuccessBrand: 'SoukElHad.ma',
      shareSuccessWeeklyVisitors: 'الزيارات الأسبوعية',
      shareSuccessProductViews: 'مشاهدات المنتجات الأسبوعية',
      shareSuccessFooterHint: 'امسح الرمز أو افتح الرابط',
      shareSuccessDownload: '📸 تحميل بطاقة النجاح',
      shareSuccessGenerating: 'جاري التصدير…',
  ...
  fr: {
    ...
    hero: {
      ...
      ctaStartShop: 'Démarrer mon Shop',
    ...
    user: {
      ...
      shareSuccessBrand: 'SoukElHad.ma',
      shareSuccessWeeklyVisitors: 'Visiteurs (7 j.)',
      shareSuccessProductViews: 'Vues produit (7 j.)',
      shareSuccessFooterHint: 'Scannez ou ouvrez le lien',
      shareSuccessDownload: '📸 Télécharger la carte',
      shareSuccessGenerating: 'Export…',
